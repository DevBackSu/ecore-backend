...
function dailychallengeDAO(day, USER_ID) {
  return new Promise(function (resolve, reject) {
    ...
    left join user_daily_challenge udc on udc.daily_challenge_id = dc.daily_challenge_id and udc.user_id = ${USER_ID} AND udc.daily_date = "${d.getFullYear()}${("0"+(d.getMonth()+1)).slice(-2)}${("0"+ d.getDate()).slice(-2)}"
