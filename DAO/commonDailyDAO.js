...
function daily_idDAO(img_id){     //user_daily_challenge_id 가져오기
...
function dailylikeDAO(daily, user_id){    //daily_like 테이블에 insert
  return new Promise(function(resolve, reject){
...
function likeUpdateDAO(img_id){     //daily_image 테이블 update
  return new Promise(function(resolve, reject){
